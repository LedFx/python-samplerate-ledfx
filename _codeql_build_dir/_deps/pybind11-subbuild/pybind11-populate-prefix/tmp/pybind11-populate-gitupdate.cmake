...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "f5fbe867d2d26e4a0a9177a51f6e568868ad3dc8"
  WORKING_DIRECTORY "/home/runner/work/python-samplerate-ledfx/python-samplerate-ledfx/_codeql_build_dir/_deps/pybind11-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "f5fbe867d2d26e4a0a9177a51f6e568868ad3dc8")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("f5fbe867d2d26e4a0a9177a51f6e568868ad3dc8" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: f5fbe867d2d26e4a0a9177a51f6e568868ad3dc8")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/f5fbe867d2d26e4a0a9177a51f6e568868ad3dc8")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"f5fbe867d2d26e4a0a9177a51f6e568868ad3dc8\" is not present locally, and not "
