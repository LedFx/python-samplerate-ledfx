...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.9.2"
  WORKING_DIRECTORY "/home/runner/work/python-samplerate-ledfx/python-samplerate-ledfx/_codeql_build_dir/_deps/nanobind-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.9.2" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v2.9.2")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v2.9.2")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v2.9.2\" is not present locally, and not "
